...
public class Options {
  ...
  private final List<OptionArg> args;
  
  
  public Options(List<OptionArg> args) {
    this.args = Objects.requireNonNull(args, "Bad null arguments list");
  }
  
  
  public boolean contains(Option opt) {
    return opt != null && args.stream().anyMatch(a->a.getOption() == opt);
  }
  
  
  public OptionArg get(Option opt) {
