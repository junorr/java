 ...
 */
public class PrimitiveArrayTransformer extends AbstractStringTransformer<Object> {
  ...
  public static boolean isSupportedArray(Class cls) {
    if(cls == null) return false;
    boolean isSupported = false;
    for(Class c : supported) {
      isSupported = isSupported || c.equals(cls);
    }
    return isSupported;
  }
