...
public class SqlQuery {
  ...
  public SqlQuery(Connection con, IniSql ini) {
    if(con == null) {
      throw new IllegalArgumentException("Invalid Null Connection");
    }
    if(ini == null || ini.queries().isEmpty()) {
  ...
  public JsonResultSet exec(String query, Object ... pars) throws SQLException {
  ...
  public String execJson(String query, Object ... pars) throws SQLException {
    return this.exec(query, pars).toJson();
  }
