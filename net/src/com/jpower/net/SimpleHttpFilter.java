 ...
 */
public class SimpleHttpFilter extends ByteFilter {
  
  public static final int CLR = 0x0A0D;
  
  
  public SimpleHttpFilter() {
    super(createFilter());
  }
  ...
  private static byte[] createFilter() {
    ...
    filter[0] = (byte) ((CLR >> 8) & 0x0000FF);
    filter[1] = (byte) (CLR & 0x000000FF);
    return filter;
  }
