 ...
 */
public class EOTFilter extends ByteFilter {
  ...
  private static byte[] createFilter() {
    ...
    filter[0] = EOF >> 24;
    filter[1] = (byte) ((EOF >> 16) & 0x00FF);
    filter[2] = (byte) ((EOF >> 8) & 0x0000FF);
    filter[3] = (byte) (EOF & 0x000000FF);
    filter[4] = CLR >> 24;
    filter[5] = (byte) ((CLR >> 16) & 0x00FF);
    filter[6] = (byte) ((CLR >> 8) & 0x0000FF);
    filter[7] = (byte) (CLR & 0x000000FF);
    return filter;
  }
