 ...
 */
public class IOCycle<I,O> implements Cycle<I,O> {
  
  private final Duplex<O,I> duplex;
  
  private final ThrowableFunction<I,O> fun;
  ...
  public IOCycle(ThrowableFunction<I,O> fn) {
  ...
  public void run() {
    while(true) {
      ...
      try {
        ...
        duplex.input().push(fun.apply(arg));
      } catch(Exception e) {
