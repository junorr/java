 ...
 */
public class RepeatableConsumerCycle<O> implements Cycle<O,Void> {
  ...
  public RepeatableConsumerCycle(ThrowableConsumer<O> fn, Function<Duplex<Void,O>,Boolean> until) {
