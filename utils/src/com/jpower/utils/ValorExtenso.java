...
public class ValorExtenso {
  ...
  private String nomesingular, nomeplural;
  ...
  public void setNomeSingular(String moeda)
  {
    if(moeda == null) return;
    this.nomesingular = moeda;
  }

  public void setNomePlural(String moeda)
  {
    if(moeda == null) return;
    this.nomeplural = moeda;
  }
  ...
  public String getNomePlural()
  {
	...
	public String toString() {
		...
		if (buf.length() > 0) {
			...
			if (nro.size() == 2 && ((Integer)nro.get(1)).intValue() == 1) {
				buf.append(" "+ nomesingular);
			} else {
				buf.append(" "+ nomeplural);
			}
	...
	public static void main(String[] args) {
		...
		ValorExtenso teste = new ValorExtenso(new BigDecimal(args[0]));
