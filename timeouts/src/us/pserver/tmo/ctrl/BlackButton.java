    ...
    implements KeyListener, FocusListener, MouseListener
{
   ...
   * Construtor com dois argumentos que recebe um objeto
   * <code>PaintStyle</code>, configurando o estilo de
   * pintura do bot�o, e uma String com o texto que
   * serah exibido.
   * @param style Configura o estilo de pintura do bot�o.
   * @param text Texo que serah exibido no bot�o.
   */
  ...
  /**
   * Retorna a imagem de �cone quando o componente
   * estiver sob o mouse.
   * @return PowerImage icon.
   */
  ...
  /**
   * Seta a imagem de �cone quando o componente
   * estiver sob o mouse.
   * @param icon PowerImage.
   */
  ...
  protected void paintComponent(Graphics g) {
    ...
    //Pinta o estilo do bot�o
    if(style.isGradientPaintEnabled()) {//Modo gradiente
      //Modo gradiente

      //Calcula a altura limite para divis�o do componente
      ...
      //Pinta um ret�ngulo come�ando no limite + o
      ...
      //Define o estilo gradiente, come�ando com
      //uma tonalidade 5% mais clara que a cor
      //mais escura, e segue com um gradiente at�
      //o in�cio do componente at� atingir a cor
      //mais clara.
      ...
      //Define o ret�ngulo a ser pintado com o gradiente,
      Rectangle r = new Rectangle(0, 0, this.getWidth(), (limit + hl));
      //Seta o estilo gradiente
      g2.setPaint(gp);
      //Pinta o ret�ngulo com o gradiente.
      g2.fill(r);

    } else {
      //Modo Normal

      //Calcula a altura onde ser� dividido o componente
      //(+/- 55% da altura).
    ...
    //vari�veis para o espe�o vertival e horizontal
    //entre a borda e o componente a ser desenhado
    int horizSpace = 0;
    int vertSpace = 0;
    //dist�ncia entre objetos desenhados
    int gap = 8;
    ...
    //Desenha o �cone se existir
    if(icon != null) {

      //calcula o espa�o vertical necess�rio entre
      //o componente a ser desenhado e a borda, considerando
      //o alinhamento setado para o bot�o.
      vertSpace = this.calculateVerticalSpace(stringHeight, icon.getHeight());

      //calcula o tamanho necess�rio para o �cone, reduzindo-o
      //se necess�rio, para caber no bot�o
      ...
      //calcula o espa�o horizontal necess�rio entre
      //o componente a ser desenhado e a borda, considerando
      //o alinhamento setado para o bot�o.
    ...
    gb.setColor(super.getForeground());
    //calcula a posi��o 'y' em que a string come�ar�
    //a ser desenhada.
    int fpy = this.calculateVerticalSpace(stringHeight, 0);

    //calcula a posi��o 'x' em que a string come�ar�
    //a ser desenhada.
    int fpx = 0;
    if(icon != null)
    ...
    for(int i = 0; i < texto.length; i++)
    {
      ...
      //este � o espa�o existente entre o texto
  ...
  /**
   * Calcula o espa�o horizontal necess�rio entre a borda do bot�o
   ...
   * @return posi��o horizontal onde o objeto ser� desenhado
   */
  ...
  /**
   * Calcula o espa�o vertical necess�rio entre a borda do bot�o
   * e o objeto a ser desenhado, considerando o alinhamento
   * interno setado.
   * @param stringWidth tamanho da String a ser desenhada, se houver.
   * @param imageWidth tamanho da imagem a ser desenhada, se houver.
   * @return posi��o vertical onde o objeto ser� desenhado
   */
