 ...
 * @author Juno
 */
public class NewJobDialog1 extends javax.swing.JDialog {
  ...
  public ScriptPair getJobPair() {
    if(rule == null || script == null)
      return null;
    return new ScriptPair(rule, new ScriptJob(script)
  ...
  public void setJobPair(ScriptPair pair) {
    ...
    schedInput.setText(rule.toString());
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(NewJobDialog1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    System.out.println("* "
        + new NewJobDialog1().showDialog(null));
  }
