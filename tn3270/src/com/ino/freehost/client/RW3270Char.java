...
public class RW3270Char
{
    ...
    * a StartField.)
    */
   public void setHighlighting(short in)
   {
      highlighting = in;
   }
   /**
    ...
    * a StartField.)
    */
   public void setOutlining(short in)
   {
      if(in == 0)
         outlining = OL_NONE;
   ...
   public final static short               HL_DEFAULT           = 0x00;//0
   public final static short               HL_NORMAL            = 0xF0;//240
   public final static short               HL_BLINK             = 0xF1;//241
   public final static short               HL_REVERSE           = 0xF2;//242
   public final static short               HL_UNDERSCORE        = 0xF4;//244
