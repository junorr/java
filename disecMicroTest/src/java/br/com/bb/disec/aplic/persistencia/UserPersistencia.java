...
public class UserPersistencia extends Persistencia {
  ...
  public static final String SQL_RESOURCE = "/resources/usu-sim-sql.xml";
  ...
  public String getQuery(String group, String name) {
    SqlXmlResource res = SqlXmlResource.resource(this.getClass(), SQL_RESOURCE);
		return res.getQuery(group, name);
  }
  
  
  public User getUser(String chave) throws SQLException {
  ...
  public Usuario getUsuario(String chave) throws SQLException {
