...
public class SystemCommand implements Runnable {
  ...
  /**
   * Retorna o c�digo de sa�da da execu��o
   * do sistema.
   * @return C�digo de retorno do sistema.
   */
  ...
  public void run() {
    ...
    try {
      ...
      if(wait) {
        ...
        //Captura a sa�da de erros do processo
