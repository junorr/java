...
public class ServerConfig {
   ...
   * @param jwtKey Chave de autenticação do servidor para
   * assinatura dos Json Web Tokens de controle de acesso.
  ...
  /**
   * Retorna a chave de assinatura do servidor para JWT.
   * @return JWTKey
   * @see br.com.bb.disec.micro.jwt.JWTKey
   */
  ...
  public static class Builder {
    ...
    /**
     * Define a chave de assinatura do servidor para JWT.
     * @param jwtAuthKey JWTKey chave de assinatura do
     * servidor para JWT.
     * @return Esta instância modificada de Builder.
     * @see br.com.bb.disec.micro.jwt.JWTKey
     */
