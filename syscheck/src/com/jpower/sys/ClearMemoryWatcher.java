 ...
 */
public class ClearMemoryWatcher implements ChangeListener {
  
  public static final int SECONDS_INTERVAL = 1000;
  
  public static final File file = new File("./mem-cache.conf");
  
  public static final String KEY_CLEAR = "clear_caches";
  
  public static final String COMMENT = 
      "ClearMemoryCache. Possible values = { true | false }.";
  
  
  private ClearMemoryCommand freeCache;
  ...
  public void stateChanged(Date date, Object o) {
    conf.load();
    boolean clear = conf.getBoolean(KEY_CLEAR);
    if(clear) {
      Log.logger().info("Clear memory cache ("+ new SimpleDate()+ ")!");
      freeCache.clearCache();
      conf.put(KEY_CLEAR, false);
      conf.save();
    }
  }
