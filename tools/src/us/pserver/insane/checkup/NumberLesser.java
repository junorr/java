 ...
 */
public class NumberLesser implements SanityCheck<Number> {
  ...
  public boolean test(Number t) {
    return Double.compare(Sane.of(t).get(new NotNull()).doubleValue(), 
  ...
  public String failMessage() {
    return String.format("Number must be lesser than %1$s. (X < %1$s)", parameter);
  }
