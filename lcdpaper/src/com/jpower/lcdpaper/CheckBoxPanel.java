 ...
 */
public class CheckBoxPanel extends JPanel implements LCDComponent, MouseListener, MouseMotionListener {
  ...
  public CheckBoxPanel() {
    ...
    check.setSize(20, 15);
    check.setLocation(5, 7);
    this.add(check);
    
    textArea = new JTextArea("Text");
    textArea.setOpaque(false);
    textArea.setLocation(30, 6);
  ...
  private void resize() {
    ...
    this.setSize(dim);
    textArea.setSize(dim.width - 30, dim.height - 10);
  ...
  public void paint(Graphics gp) {
    ...
    g = gp.create();
    g.translate(check.getX(), check.getY());
    check.paint(g);
    g.dispose();
  ...
  public static void main(String[] args) {
    ...
    CheckBoxPanel tp = new CheckBoxPanel();
