 ...
 * Coleção de endereços de destinatários de emails,
 * suportada por uma lista interna.
 * </p>
 *
...
@Version (
    ...
    name      = "Recipients",
		date			= "2011.10.13",
		author		= "Juno Roesler",
		synopsis	= "Coleção de destinatários de email"
)
@Copyright("2011 Juno Roesler")
@Contact("juno.rr@gmail.com")
@License("GNU/LGPL v2.1")
public class Recipients extends TypeLinkedList<String> {
