 ...
 * Filtro para pesquisa de mensagens removidas/apagadas.
 * </p>
 * 
...
@Version (
		value			= "1.0",
    name      = "DeletedMessageFilter",
		date			= "2011.10.13",
		author		= "Juno Roesler",
		synopsis	= "Filtro para pesquisa de mensagens removidas/apagadas"
)
@Copyright("2011 Juno Roesler")
@Contact("juno.rr@gmail.com")
@License("GNU/LGPL v2.1")
public class DeletedMessageFilter implements Filter<Message> {


  /**
   * Verifica se a mensagem informada foi 
   * removida da caixa de emails.
   * @param e Mensagem a ser comparada.
   * @return <code>true</code> se a mensagem 
   * foi apagada da caixa de emails, 
