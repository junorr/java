 ...
 * Filtro para identificação de novas mensagens (não lidas).
 * </p>
 *
...
@Version (
    ...
    name      = "NewMessageFilter",
		date			= "2011.10.13",
		author		= "Juno Roesler",
		synopsis	= "Filtro para identificação de novas mensagens"
)
@Copyright("2011 Juno Roesler")
@Contact("juno.rr@gmail.com")
@License("GNU/LGPL v2.1")
public class NewMessageFilter implements Filter<Message> {


  /**
   * Verifica se a mensagem informada é 
   * nova e ainda não lida.
   * @param e Mensagem a ser verificada.
   * @return <code>true</code> se a mensagem 
   * é nova e ainda não lida, 
