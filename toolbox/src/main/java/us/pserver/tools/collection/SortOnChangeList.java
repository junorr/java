 ...
 */
public class SortOnChangeList<T> implements List<T> {
  ...
  public SortOnChangeList(List<T> lst, Comparator<T> cmp) {
    this.compare = cmp;
    this.list = Match.notNull(lst).getOrFail("Bad null List");
  }
  
  
  public SortOnChangeList(Comparator<T> cmp) {
    this(new ArrayList<>(), cmp);
  }
  
  
  public SortOnChangeList(List<T> lst) {
    this(lst, null);
  }
  
  
  public SortOnChangeList() {
    this(new ArrayList<>(), null);
  }
  
  
  public SortOnChangeList<T> sort() {
    if(compare == null) {
  ...
  public SortOnChangeList<T> put(T e) {
