 ...
 */
public class PrintParser extends CommandParser {


  @Override
  public boolean canParse(String str) {
    return canParseBasic(str, Command.STR_PRINT);
  }
  ...
  public Command parse(String str) {
    ...
    String val = str.substring(Command.STR_PRINT.length()+1);
    ...
    return new Command(CommandType.PRINT).setArg(val, 0);
  }
