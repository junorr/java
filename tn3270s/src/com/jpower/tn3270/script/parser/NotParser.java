 ...
 */
public class NotParser extends CommandParser {


  @Override
  public boolean canParse(String str) {
    return canParseBasic(str, Command.STR_NOT);
  }
  ...
  public Command parse(String str) {
    ...
    String val = str.substring(Command.STR_NOT.length()+1);
    ...
    return new Command(CommandType.NOT).setArg(val, 0);
  }
