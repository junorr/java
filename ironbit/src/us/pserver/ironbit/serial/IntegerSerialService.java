 ...
 */
public class IntegerSerialService implements SerialService<Integer> {

  @Override
  public SerialRecord serialize(String name, Integer obj) {
    byte[] bs = new byte[Integer.BYTES];
    SerialCommons.writeInt(obj, bs, 0);
    return new DefaultSerialRecord(IronbitConfiguration.get().registerClassID(obj.getClass()), name, bs);
  }

  @Override
  public Integer deserialize(SerialRecord rec) {
    return SerialCommons.readInt(rec.getValue(), 0);
  }
