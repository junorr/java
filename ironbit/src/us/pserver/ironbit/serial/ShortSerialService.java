 ...
 */
public class ShortSerialService implements SerialService<Short> {

  @Override
  public SerialRecord serialize(String name, Short obj) {
    byte[] bs = new byte[Short.BYTES];
    SerialCommons.writeShort(obj, bs, 0);
    return new DefaultSerialRecord(IronbitConfiguration.get().registerClassID(obj.getClass()), name, bs);
  }

  @Override
  public Short deserialize(SerialRecord rec) {
    return SerialCommons.readShort(rec.getValue(), 0);
  }
