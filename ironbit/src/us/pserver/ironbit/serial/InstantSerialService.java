 ...
 */
public class InstantSerialService implements SerialService<Instant> {
  
  @Override
  public SerialRecord serialize(String name, Instant obj) {
  ...
  @Override
  public Instant deserialize(SerialRecord rec) {
