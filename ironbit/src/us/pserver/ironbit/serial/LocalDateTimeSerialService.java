 ...
 */
public class LocalDateTimeSerialService implements SerialService<LocalDateTime> {

  @Override
  public SerialRecord serialize(String name, LocalDateTime obj) {
    byte[] bs = UTF8String.from(DateTime.of(obj).toZonedDT()
  ...
  @Override
  public LocalDateTime deserialize(SerialRecord rec) {
