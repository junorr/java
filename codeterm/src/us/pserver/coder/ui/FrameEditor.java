...
import us.pserver.coder.CodetermConfig;
import us.pserver.coder.Editor;
import us.pserver.coder.util.IconProvider;
import us.pserver.coder.util.ScreenPositioner;
import us.pserver.coder.util.TextCopy;
...
public class FrameEditor extends javax.swing.JFrame {
  ...
  private File lastFile, currFile;
  ...
  private void initComponents() {
    ...
    saveAction = new us.pserver.coder.ui.ActionLabel();
    openAction = new us.pserver.coder.ui.ActionLabel();
    copyAction = new us.pserver.coder.ui.ActionLabel();
    pasteAction = new us.pserver.coder.ui.ActionLabel();
    findAction = new us.pserver.coder.ui.ActionLabel();
    undoAction = new us.pserver.coder.ui.ActionLabel();
    redoAction = new us.pserver.coder.ui.ActionLabel();
    highlightsAction = new us.pserver.coder.ui.ActionLabel();
    colorsAction = new us.pserver.coder.ui.ActionLabel();
    hideAction = new us.pserver.coder.ui.ActionLabel();
    ...
    setIconImage(us.pserver.coder.util.IconProvider.getIconCodeterm());
  ...
  private us.pserver.coder.ui.ActionLabel colorsAction;
  private javax.swing.JPanel content;
  private us.pserver.coder.ui.ActionLabel copyAction;
  private us.pserver.coder.ui.ActionLabel findAction;
  private us.pserver.coder.ui.ActionLabel hideAction;
  private us.pserver.coder.ui.ActionLabel highlightsAction;
  ...
  private us.pserver.coder.ui.ActionLabel openAction;
  private us.pserver.coder.ui.ActionLabel pasteAction;
  private us.pserver.coder.ui.ActionLabel redoAction;
  private us.pserver.coder.ui.ActionLabel saveAction;
  private javax.swing.JScrollPane scroll;
  private javax.swing.JLabel statusbar;
  private us.pserver.coder.ui.ActionLabel undoAction;
