...
public class SimpleDB1 {
  ...
  public SimpleDB1(StorageEngine eng) throws SDBException {
    if(eng == null)
  ...
  public SimpleDB1 setRemoveOnCascade(boolean bool) {
    rmcascade = bool;
    return this;
  }
  ...
  public Result remove(Query1 q) throws SDBException {
    Result res = get(q);
    for(Document d : res)
      this.remove(d.block());
    return res;
  ...
  public Document getOne(Query1 q) throws SDBException {
