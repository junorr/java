...
public class DBOneException extends RuntimeException {
  ...
  public DBOneException() {
  }

  public DBOneException(String message) {
    super(message);
  }

  public DBOneException(String message, Object ... args) {
    super(String.format(message, args));
  }

  public DBOneException(String message, Throwable cause) {
    super(message, cause);
  }

  public DBOneException(Throwable cause, String message, Object ... args) {
    super(String.format(message, args), cause);
  }

  public DBOneException(Throwable cause) {
    super(cause);
  }
  ...
  public static <T,R> R rethrow(ThrowableFunction<T,R> fn, T t) {
    try {
      ...
      throw new DBOneException(e.toString(), e);
    }
  }
