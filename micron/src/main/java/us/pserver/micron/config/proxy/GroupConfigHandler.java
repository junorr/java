 ...
 */
public class GroupConfigHandler implements InvocationHandler, Group {
  
  private final Config cfg;
  
  public GroupConfigHandler(Config cfg) {
  ...
  public Set<String> getItems() {
    return new HashSet<>(cfg.get("users").asList(String.class).get());
  }
  ...
  @Override
  public Group.GroupBuilder edit() {
  ...
  public String toString() {
    return "Group{ name=" + getName() + ", items=" + getItems() + ", created=" + getCreated() + " }";
  }
