...
public interface IGroup {
  ...
  public static interface IBuilder {
    ...
    public IBuilder setUsernames(Set<String> usernames);
    
    public IBuilder clearUsernames();
    
    public IBuilder addUsername(String username);
    
    public IBuilder addUser(IUser user);
