 ...
 * Ouvinte de eventos de recebimento de email, pode
...
@Version (
		value			= "1.0",
    name      = "ReceiveMailListener",
		date			= "2011.10.13",
		author		= "Juno Roesler",
		synopsis	= "Ouvinte de eventos de recebimento de email"
)
@Copyright("2011 Juno Roesler")
@Contact("juno.rr@gmail.com")
@License("GNU/LGPL v2.1")
public interface ReceiveMailListener extends Listener {
  ...
  /**
   * Método invocado quando um email for recebido
   * com sucesso.
   * @param event evento de email.
   */
