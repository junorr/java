 ...
 * Interface implementada por ouvintes
 * de eventos gerados por MailBox, quando
 * ocorrerem mudanças na caixa de emails.
 * </p>
 *
...
@Version (
		value			= "1.0",
    name      = "MailBoxListener",
		date			= "2011.10.13",
		author		= "Juno Roesler",
		synopsis	= "Ouvinte de eventos de MailBox"
)
@Copyright("2011 Juno Roesler")
@Contact("juno.rr@gmail.com")
@License("GNU/LGPL v2.1")
public interface MailBoxListener extends Listener {
  
  
  /**
   * Método invocado quando uma mensagem for recebida.
   * @param e evento gerado por MailBox.
   */
  public void messageReceived(MailBoxEvent e);
  
  
  /**
   * Método invocado quando a caixa de emails 
