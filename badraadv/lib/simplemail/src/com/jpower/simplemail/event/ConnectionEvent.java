 ...
 * Evento de conexão com o servidor de email.
 * </p>
 *
...
@Version (
    ...
    name      = "ConnectionEvent",
		date			= "2011.10.13",
		author		= "Juno Roesler",
		synopsis	= "Evento de conexão"
)
@Copyright("2011 Juno Roesler")
@Contact("juno.rr@gmail.com")
@License("GNU/LGPL v2.1")
public class ConnectionEvent extends AbstractEvent<SMail> {
  ...
  /**
   * Construtor que recebe o objeto SMail 
   * gerador do evento.
   * @param src Objeto SMail gerador do evento.
   */
  public ConnectionEvent(SMail src) {
    super(src);
  }
