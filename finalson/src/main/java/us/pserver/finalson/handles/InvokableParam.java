 ...
 */
public interface InvokableParam extends Comparable<InvokableParam> {
  ...
  @Override
  public default int compareTo(InvokableParam other) {
    return Integer.compare(this.index(), other.index());
  }
  
  
  
  public static InvokableParam of(int index, Parameter param, JsonProperty prop) {
  ...
  public static class DefaultConstructParam implements InvokableParam {
    ...
    public boolean equals(Object obj) {
      ...
      final InvokableParam other = (InvokableParam) obj;
      ...
      return Objects.equals(this.prop, other.getJsonProperty());
    }


    @Override
    public String toString() {
      return String.format("%s{%d. %s -> %s}", InvokableParam.class.getSimpleName(), index, param, prop);
    }
