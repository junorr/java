...
public class ByteBufferPool extends DefaultPool<ByteBuffer> {
  ...
  public ByteBufferPool(ByteBufferPoolConfiguration cfg, IntFunction<ByteBuffer> allocfun) {
    super(cfg, () -> allocfun.apply(cfg.getUnitBufferSize()));
  }
  
  public ByteBufferPool(ByteBufferPoolConfiguration cfg) {
    this(cfg, DEFAULT_ALLOC_FUNCTION);
  }

  @Override
  public ByteBufferPoolConfiguration getPoolConfiguration() {
    return (ByteBufferPoolConfiguration) super.getPoolConfiguration();
  }
