 ...
 */
public class ClientChannel2 implements Channel, Runnable {
  ...
  public ClientChannel2(SocketChannel sock, Selector select, ChannelConfiguration cfg, ChannelEngine eng, ChannelStream stream) {
