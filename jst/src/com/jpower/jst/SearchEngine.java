 ...
 * indicador de precisao, que deve ser definido antes da
 * busca.<br>
 ...
 * <i>"Projeto Alpha Centauro"</i>, buscando resultados com
 * precisão maior ou igual a <b>80%</b>.<br><br>
 * </p>
 * <code>
 * <pre>
 * SearchEngine eng = new SearchEngine();
 * eng.setAccuracy(SearchEngine.ACCURACY_80);
 * //eng.setAccuracy(0.8);
 * eng.setSource(SearchEngine.toSearch("Projeto Alpha Centurion"));
 * eng.setSearch(SearchEngine.toSearch("projet"));
 * double precisao = eng.search();
 * //precisao = eng.getLastResult();
 * </pre>
 * </code>
 * <p style="font-size: medium;">
...
@Version (
    ...
    name      = "SearchEngine",
		date			= "2011.11.25",
		author		= "Juno Roesler",
		synopsis	= "Motor de pesquisa de textos"
)
...
public class SearchEngine {
	...
	/**
	 * Nével de precisão do motor de pesquisa.
	 */
	 ...
	 */
	public SearchText getText() { return search; }

	/**
	 * Seta o texto a ser pesquisado.
	 * @param search texto a ser pesquisado.
	 */
	public void setText(SearchText search) {
		this.search = search;
	}
	...
	public static void main(String[] args) {
		String source =
				...
				+ "  distribuéda com o Kubuntu 10.10 impressiona em termos de visual,\n"
				...
				+ "  e sugestões para um elegante visual.";
		...
		SearchEngine eng = new SearchEngine();
    eng.setAccuracy(ACCURACY_70);
		eng.setSource(SearchEngine.toSearch(source));
		eng.setText(SearchEngine.toSearch(search));
