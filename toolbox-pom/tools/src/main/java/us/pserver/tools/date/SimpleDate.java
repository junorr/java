...
public class SimpleDate extends Date {
  ...
  @Override
	 ...
	 * Retorna o dia da semana.
	 * @return dia da semana.
   * @see us.pserver.tools.date.DayOfWeek
	 */
  ...
  public Instant toInstant() {
	...
	/**
	 * Converte para ZonedDateTime with default ZoneId.
	...
	/**
	 * Converte para ZonedDateTime with the informed ZoneId.
	 * @return ZonedDateTime
	 */
	public ZonedDateTime toZonedDateTime(ZoneId id) {
		return ZonedDateTime.of(toLocalDateTime(), id);
	}
