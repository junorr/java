...
package us.pserver.tools.match.test;

import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.Test;
import us.pserver.tools.match.Match;
...
public class TestMatch {
  ...
  @Test
  public void matchNotEmptyGetOrFail() {
    String str = "Leitão";
    Assertions.assertEquals(str, Match.notEmpty(str).getOrFail("Bad null String: '%s'", str));
  }
