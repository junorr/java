 ...
 */
public class DefaultJsonParser extends AbstractObservableHandler implements JsonParser {
  ...
  public DefaultJsonParser(ReadableByteChannel rbc) {
    this(rbc, Charset.forName("UTF-8"));
  }
  
  
  public DefaultJsonParser(ReadableByteChannel rbc, Charset cst) {
    if(rbc == null) {
