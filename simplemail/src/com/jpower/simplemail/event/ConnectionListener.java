 ...
 * Interface implementada por objetos
 * ouvintes de eventos de conexão com o 
 * servidor de email.
 * </p>
 *
...
@Version (
    ...
    name      = "ConnectionListener",
		date			= "2011.10.13",
		author		= "Juno Roesler",
		synopsis	= "Ouvinte de evento de conexão"
)
...
public interface ConnectionListener extends Listener {
  ...
  /**
   * Método invocado quando uma conexão estiver 
   * sendo realizada.
  ...
  /**
   * Método invocado quando uma conexão for 
   * estabelecida.
   * @param event Evento de conexão.
   */
